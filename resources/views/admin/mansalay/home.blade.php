...
<html lang="en" class="light">
    ...
    <body class="py-5 md:py-0 bg-black/[0.15] dark:bg-transparent">
        ...
        @include('admin.mansalay.mobile')

        <div class="flex mt-[4.7rem] md:mt-0 overflow-hidden">
            @include('admin.mansalay.sidebar')
            ...
            <div class="content">
                ...
                <div class="top-bar -mx-4 px-4 md:mx-0 md:px-0">
                    ...
                    <nav aria-label="breadcrumb" class="-intro-x mr-auto hidden sm:flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/home">Mansalay</a></li>
                ...
                <div class="dashboard mt-5">
                    <div class="up-event">
                        ...
                        <a href="/mansalay-incoming-event" class="btn btn-success">View</a>
                    </div>
                    ...
                    <div class="pst-event">
                        ...
                        <a href="/mansalay-past-event" class="btn btn-success">View</a>
                    </div>
                    ...
                    <div class="act-profile">
                        ...
                        <a href="/mansalayprofile" class="btn btn-success">View</a>
                    </div>
                    ...
                    <div class="inc-profile">
                        ...
                        <a href="/mansalay-inactive" class="btn btn-success">View</a>
                    </div>
                    ...
                    <div class="acc-report">
                        ...
                        <a href="/mansalay-accomplishment-report" class="btn btn-success">View</a>
                    </div>
                    ...
                    <div class="mon-report">
                        ...
                        <a href="/mansalay-monitoring-report" class="btn btn-success">View</a>
                    </div>
                </div>
