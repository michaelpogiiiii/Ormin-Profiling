    ...
    <div class="flex mt-[4.7rem] md:mt-0 overflow-hidden">
        ...
        <div class="content">
            ...
            <div class="acc-report mt-5">
                @include('admin.naujan.add-acc')
                <div class="mt-3 d-flex justify-content-between">
                    <h3 style="font-size:30px;font-weight:700;">Accomplishment Report</h3>
                    <form action="{{ url('naujan-accomplishment-report') }}" type="GET">
                        ...
                        @foreach ($data as $report)
                            <div class="folder-box" style="position: relative;">
                                ...
                                <div class="btns"
                                    ...
                                    <a href="{{ url('download-gloria-acc', [$report->id, $report->municipality]) }}"
                                        class="text-secondary" download><i class="fa fa-download"
                                            style=" font-size:20px;"></i>
                                    </a>
                                    <a href="{{ url('delete-gloria-acc', [$report->id, $report->municipality]) }}"
