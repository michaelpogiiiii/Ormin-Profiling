    ...
    <div class="flex mt-[4.7rem] md:mt-0 overflow-hidden">
        ...
        <div class="content">
            ...
            <div class="mon-report mt-5">
                @include('admin.victoria.add-mon')
                <div class="mt-3 d-flex justify-content-between">
                    <h3 style="font-size:40px;font-weight:700;">Monitoring Report</h3>
                    <form action="{{url('victoria-monitoring-report')}}" type="GET" >
                        <input type="search" name="file" placeholder="Search File" autocomplete="off" class="rounded" style="color:rgb(80, 91, 91);" oninput="delayedSubmit(this)">
                        ...
                        @foreach ($data as $report)
                            <div class="folder-box" style="position: relative;">
                                ...
                                <div class="btns"
                                    ...
                                    <a href="{{ url('download-victoria-mon', [$report->id, $report->municipality]) }}"
                                        class="text-secondary" download><i class="fa fa-download"
                                            style=" font-size:20px;"></i>
                                    </a>
                                    <a href="{{ url('delete-victoria-mon', [$report->id, $report->municipality]) }}"
