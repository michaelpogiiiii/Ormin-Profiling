    ...
    <div class="flex mt-[4.7rem] md:mt-0 overflow-hidden">
        ...
        <div class="content">
            ...
            <div class="mon-report mt-5">
                @include('admin.pinamalayan.add-mon')
                <div class="mt-3 d-flex justify-content-between">
                    <h3 style="font-size:30px;font-weight:700;">Monitoring Report</h3>
                    <form action="{{ url('pinamalayan-monitoring-report') }}" type="GET">
                        ...
                        @foreach ($data as $report)
                            <div class="folder-box" style="position: relative;">
                                ...
                                <div class="btns"
                                    ...
                                    <a href="{{ url('download-pinamalayan-mon', [$report->id, $report->municipality]) }}"
                                        class="text-secondary" download><i class="fa fa-download"
                                            style=" font-size:20px;"></i>
                                    </a>
                                    <a href="{{ url('delete-pinamalayan-mon', [$report->id, $report->municipality]) }}"
