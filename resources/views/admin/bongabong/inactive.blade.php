...
<body class="py-5 md:py-0 bg-black/[0.15] dark:bg-transparent">
    ...
    <div class="flex mt-[4.7rem] md:mt-0 overflow-hidden">
        ...
        <div class="content">
            ...
            <form action="{{ url('bongabong-inactive') }}" type="GET">
            ...
            <!-- END: Top Bar -->
            <div class="mt-3">
                <a href="{{ url('bongabongprofile') }}" class="btn btn-success">View Active Profiles</a>
            </div>
            @php
                use Carbon\Carbon;
                ...
                <table class="mt-5" id="responsive-table">
                    ...
                    @foreach ($filteredProfiles as $data)
                        ...
                        <tr>
                            ...
                            <td>{{ $data->barangay }}</td>
                            <td>
                                <a href="{{ url('bongabong-profile-inactive', $data->id) }}" class="btn btn-success">
