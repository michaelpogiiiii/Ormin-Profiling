...
<html lang="en" class="light">
    ...
    <body class="py-5 md:py-0 bg-black/[0.15] dark:bg-transparent">
        ...
        @include('admin.puerto.mobile')

        <div class="flex mt-[4.7rem] md:mt-0 overflow-hidden">
            @include('admin.puerto.sidebar')
            ...
            <div class="content">
                ...
                <div class="dashboard mt-5">
                    <div class="up-event">
                        ...
                        <a href="/puerto-incoming-event" class="btn btn-success">View</a>
                    </div>
                    ...
                    <div class="pst-event">
                        ...
                        <a href="/puerto-past-event" class="btn btn-success">View</a>
                    </div>
                    ...
                    <div class="act-profile">
                        ...
                        <a href="/puertoprofile" class="btn btn-success">View</a>
                    </div>
                    ...
                    <div class="inc-profile">
                        ...
                        <a href="/puerto-inactive" class="btn btn-success">View</a>
                    </div>
                    ...
                    <div class="acc-report">
                        ...
                        <a href="/puerto-accomplishment-report" class="btn btn-success">View</a>
                    </div>
                    ...
                    <div class="mon-report">
                        ...
                        <a href="/puerto-monitoring-report" class="btn btn-success">View</a>
                    </div>
                </div>
