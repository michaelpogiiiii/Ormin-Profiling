            ...
            <div class="content">
                ...
                <div class="top-bar -mx-4 px-4 md:mx-0 md:px-0">
                    ...
                    <nav aria-label="breadcrumb" class="-intro-x mr-auto hidden sm:flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/">Socorro</a></li>
                ...
                <!-- END: Top Bar -->
                <div class="mt-5">
                    @include('admin.socorro.add-event')
                </div>
                {{-- Message --}}
                    ...
                    <div class="mt-5 owl-carousel p-2">
                        @foreach($showEvents as $data)
                            <div class="item" style="height: 450px;position: relative;">
                                ...
                                <a style="position: absolute; bottom:10px; right:10px;" href="{{url('delete-socorro-event', $data->id)}}" onclick="return confirm('Delete event?')"><i class="fa fa-trash mt-3 text-danger" style="font-size: 30px"></i></a>
                            </div>
                        @endforeach
                    </div>
                @endif
