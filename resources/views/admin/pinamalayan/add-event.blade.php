...
<div class="event-modal" id="event-modal">
    <div class="modal-content">
        ...
        <form action="{{url('save-pinamalayan-event')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <label for="name">Event Name</label>
            <input id="name" type="text" name="name" required>

            <input id="municipality" type="text" name="municipality" hidden value="Pinamalayan">
