...
<div class="mobile-menu md:hidden">
    ...
    <div class="scrollable">
        ...
        <ul class="scrollable__content py-2">
            ...
            <li>
                <a href="{{ url('victoriaprofile') }}" class="menu">
            ...
            <li>
                ...
                <ul class="">
                    <li>
                        <a href="{{ url('victoria-past-event') }}" class="menu">
                            <div class="menu__icon"> <i data-lucide="activity"></i> </div>
                            <div class="menu__title"> Past Events </div>
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('victoria-incoming-event') }}" class="menu">
                            <div class="menu__icon"> <i data-lucide="activity"></i> </div>
            ...
            <li>
                ...
                <ul class="">
                    <li>
                        <a href="{{ url('victoria-accomplishment-report') }}" class="menu">
                            <div class="menu__icon"> <i data-lucide="file"></i> </div>
                            <div class="menu__title"> Accomplishment Report </div>
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('victoria-monitoring-report') }}" class="menu">
                            <div class="menu__icon"> <i data-lucide="file"></i> </div>
