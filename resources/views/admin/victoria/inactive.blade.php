...
<html lang="en" class="light">
    ...
    <body class="py-5 md:py-0 bg-black/[0.15] dark:bg-transparent">
        ...
        @include('admin.victoria.mobile')

        <div class="flex mt-[4.7rem] md:mt-0 overflow-hidden">
            @include('admin.victoria.sidebar')
            ...
            <div class="content">
                ...
                <div class="top-bar -mx-4 px-4 md:mx-0 md:px-0">
                    ...
                    <nav aria-label="breadcrumb" class="-intro-x mr-auto hidden sm:flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/home">Victoria</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Registered Profiles <span class="text-danger">> Inactive</span></li>
                        </ol>
                    </nav>
                    <!-- END: Breadcrumb -->
                </div>

                <form action="{{url('victoria-inactive')}}" type="GET" >
                    <input type="search" name="users" placeholder="Search Profile" autocomplete="off" class="rounded" style="color:rgb(80, 91, 91);" oninput="delayedSubmit(this)">
                    <button class="btn btn-success mt-1"><i class="fa fa-search"></i></button>
                </form>
                <!-- END: Top Bar -->
                <div class="mt-3">
                  <a href="{{url('victoriaprofile')}}" class="btn btn-success">View Active Profiles</a>
                </div>
                @php
                use Carbon\Carbon;
                $currentDate = Carbon::now();
                $filteredProfiles = $victoria_profiles->filter(function($data) use ($currentDate) {
                ...
                <table class="mt-5" id="responsive-table">
                    ...
                    @foreach ($filteredProfiles as $data)
                        ...
                        <tr>
                            ...
                            <td>{{ $data->barangay }}</td>
                            <td>
                                <a href="{{ url('victoria-profile-inactive', $data->id) }}" class="btn btn-success">
