    ...
    <body class="py-5 md:py-0 bg-black/[0.15] dark:bg-transparent">
        ...
        <div class="flex mt-[4.7rem] md:mt-0 overflow-hidden">
            ...
            <div class="content">
                ...
                <!-- END: Top Bar -->
                <div class="mt-5">
                    @include('admin.gloria.add-event')
                </div>
                {{-- Message --}}
                    ...
                    <div class="mt-5 owl-carousel p-2">
                        @foreach($showEvents as $data)
                            <div class="item" style="height: 450px;position: relative;">
                                ...
                                <a style="position: absolute; bottom:10px; right:10px;" href="{{url('delete-gloria-event', $data->id)}}" onclick="return confirm('Delete event?')"><i class="fa fa-trash mt-3 text-danger" style="font-size: 30px"></i></a>
                            </div>
                        @endforeach
                    </div>
                @endif
