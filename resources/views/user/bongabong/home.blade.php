...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupport">
                    <ul class="navbar-nav ml-auto">
                        ...
                        @endif
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('BongabongProfiling') }}">Profiling</a>
                        </li>
    ...
    @include('user.bongabong.programs')

    @include('user.bongabong.announcement')
    <!-- .page-section -->
