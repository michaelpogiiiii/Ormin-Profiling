...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupport">
                    <ul class="navbar-nav ml-auto">
                        ...
                        @endif
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('BulalacaoProfiling') }}">Profiling</a>
                        </li>
    ...
    @include('user.bulalacao.programs')

    @include('user.bulalacao.announcement')
    <!-- .page-section -->
