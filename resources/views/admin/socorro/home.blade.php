...
<html lang="en" class="light">
    ...
    <body class="py-5 md:py-0 bg-black/[0.15] dark:bg-transparent">
        ...
        @include('admin.socorro.mobile')

        <div class="flex mt-[4.7rem] md:mt-0 overflow-hidden">
            @include('admin.socorro.sidebar')
            ...
            <div class="content">
                ...
                <div class="top-bar -mx-4 px-4 md:mx-0 md:px-0">
                    ...
                    <nav aria-label="breadcrumb" class="-intro-x mr-auto hidden sm:flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/home">Socorro</a></li>
                ...
                <div class="dashboard mt-5">
                    <div class="up-event">
                        ...
                        <a href="/socorro-incoming-event" class="btn btn-success">View</a>
                    </div>
                    ...
                    <div class="pst-event">
                        ...
                        <a href="/socorro-past-event" class="btn btn-success">View</a>
                    </div>
                    ...
                    <div class="act-profile">
                        ...
                        <a href="/socorroprofile" class="btn btn-success">View</a>
                    </div>
                    ...
                    <div class="inc-profile">
                        ...
                        <a href="/socorro-inactive" class="btn btn-success">View</a>
                    </div>
                    <div class="acc-report">
                        ...
                        <a href="/socorro-accomplishment-report" class="btn btn-success">View</a>
                    </div>
                    ...
                    <div class="mon-report">
                        ...
                        <a href="/socorro-monitoring-report" class="btn btn-success">View</a>
                    </div>
                </div>
