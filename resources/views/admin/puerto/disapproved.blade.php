        ...
        <div class="content">
            ...
            <div class="top-bar -mx-4 px-4 md:mx-0 md:px-0">
                ...
                <nav aria-label="breadcrumb" class="-intro-x mr-auto hidden sm:flex">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/home">Puerto Admin</a></li>
            ...
            <div class="acc-report mt-5">
                @include('admin.puerto.add-acc')
                <div class="mt-3 d-flex justify-content-between">
                    <h3 style="font-size:30px;font-weight:700;">Accomplishment Report</h3>
                    <form action="{{ url('puerto-accomplishment-report') }}" type="GET">
                        ...
                        @foreach ($data as $report)
                            <div class="folder-box" style="position: relative;">
                                ...
                                <div class="btns"
                                    ...
                                    <a href="{{ url('download-puerto-acc', [$report->id, $report->municipality]) }}"
                                        class="text-secondary" download><i class="fa fa-download"
                                            style=" font-size:20px;"></i>
                                    </a>
                                    <a href="{{ url('delete-puerto-acc', [$report->id, $report->municipality]) }}"
