        ...
        <div class="flex mt-[4.7rem] md:mt-0 overflow-hidden">
            ...
            <div class="content">
                ...
                <div class="resident-info mt-5">
                    ...
                    <div class="box">
                        <p>Full Name: {{$data->firstname}} {{$data->middlename}} {{$data->lastname}} {{$data->suffix}}</p>
                        <p>Sex: {{$data->sex}}</p>
                        <p>Birthday: {{ date('F d, Y', strtotime($data->bday)) }}</p>
                        <p>Age: {{$data->age}}</p>
                    ...
                    @endforeach
                    <a href="{{url('/bulalacao-inactive')}}" class="btn btn-success" >Back</a>
                </div>
