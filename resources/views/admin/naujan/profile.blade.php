        ...
        <div class="content">
            ...
            <div class="top-bar -mx-4 px-4 md:mx-0 md:px-0">
                ...
                <nav aria-label="breadcrumb" class="-intro-x mr-auto hidden sm:flex">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/home">Nuajan Admin</a></li>
            ...
            <form action="{{ url('naujanprofile') }}" type="GET">
            ...
            <!-- END: Top Bar -->
            <div class="mt-3">
                <a href="{{ url('naujan-inactive') }}" class="btn btn-danger">View Inactive Profiles</a>
            </div>
            @php
                use Carbon\Carbon;
                ...
                <table class="mt-5" id="responsive-table">
                    ...
                    @foreach ($filteredProfiles as $data)
                        ...
                        <tr>
                            ...
                            <td>{{ $data->barangay }}</td>
                            <td>
                                <a href="{{ url('naujan-profile', $data->id) }}" class="btn btn-success">
