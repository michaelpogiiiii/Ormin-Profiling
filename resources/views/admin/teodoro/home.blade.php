...
<html lang="en" class="light">
    ...
    <body class="py-5 md:py-0 bg-black/[0.15] dark:bg-transparent">
        ...
        @include('admin.teodoro.mobile')

        <div class="flex mt-[4.7rem] md:mt-0 overflow-hidden">
            @include('admin.teodoro.sidebar')
            ...
            <div class="content">
                ...
                <div class="top-bar -mx-4 px-4 md:mx-0 md:px-0">
                    ...
                    <nav aria-label="breadcrumb" class="-intro-x mr-auto hidden sm:flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/home">San Teodoro</a></li>
                ...
                <div class="dashboard mt-5">
                    <div class="up-event">
                        ...
                        <a href="/teodoro-incoming-event" class="btn btn-success">View</a>
                    </div>
                    ...
                    <div class="pst-event">
                        ...
                        <a href="/teodoro-past-event" class="btn btn-success">View</a>
                    </div>
                    ...
                    <div class="act-profile">
                        ...
                        <a href="/teodoroprofile" class="btn btn-success">View</a>
                    </div>
                    ...
                    <div class="inc-profile">
                        ...
                        <a href="/teodoro-inactive" class="btn btn-success">View</a>
                    </div>
                    ...
                    <div class="acc-report">
                        ...
                        <a href="/teodoro-accomplishment-report" class="btn btn-success">View</a>
                    </div>
                    ...
                    <div class="mon-report">
                        ...
                        <a href="/teodoro-monitoring-report" class="btn btn-success">View</a>
                    </div>
                </div>
