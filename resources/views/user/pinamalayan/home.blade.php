...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupport">
                    <ul class="navbar-nav ml-auto">
                        ...
                        @endif
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('PinamalayanProfiling') }}">Profiling</a>
                        </li>
    ...
    @include('user.pinamalayan.programs')

    @include('user.pinamalayan.announcement')
    <!-- .page-section -->
    ...
    @include('user.pinamalayan.footer')
