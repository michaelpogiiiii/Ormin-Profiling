...
<html lang="en" class="light">
    ...
    <body class="py-5 md:py-0 bg-black/[0.15] dark:bg-transparent">
        ...
        @include('admin.bulalacao.mobile')

        <div class="flex mt-[4.7rem] md:mt-0 overflow-hidden">
            @include('admin.bulalacao.sidebar')
            ...
            <div class="content">
                ...
                <div class="top-bar -mx-4 px-4 md:mx-0 md:px-0">
                    ...
                    <nav aria-label="breadcrumb" class="-intro-x mr-auto hidden sm:flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/home">Bulalacao</a></li>
                ...
                <div class="dashboard mt-5">
                    <div class="up-event">
                        ...
                        <a href="/bulalacao-incoming-event" class="btn btn-success">View</a>
                    </div>
                    ...
                    <div class="pst-event">
                        ...
                        <a href="/bulalacao-past-event" class="btn btn-success">View</a>
                    </div>
                    ...
                    <div class="act-profile">
                        ...
                        <a href="/bulalacaoprofile" class="btn btn-success">View</a>
                    </div>
                    ...
                    <div class="inc-profile">
                        ...
                        <a href="/bulalacao-inactive" class="btn btn-success">View</a>
                    </div>
                    ...
                    <div class="acc-report">
                        ...
                        <a href="/bulalacao-accomplishment-report" class="btn btn-success">View</a>
                    </div>
                    ...
                    <div class="mon-report">
                        ...
                        <a href="/bulalacao-monitoring-report" class="btn btn-success">View</a>
                    </div>
                </div>
