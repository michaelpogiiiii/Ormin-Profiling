    ...
    <body class="py-5 md:py-0 bg-black/[0.15] dark:bg-transparent">
        ...
        <div class="flex mt-[4.7rem] md:mt-0 overflow-hidden">
            ...
            <div class="content">
                ...
                <form action="{{url('socorroprofile')}}" type="GET" >
                ...
                <!-- END: Top Bar -->
                <div class="mt-3">
                  <a href="{{url('socorro-inactive')}}" class="btn btn-danger">View Inactive Profiles</a>
                </div>
                @php
                use Carbon\Carbon;
                $currentDate = Carbon::now();
                $filteredProfiles = $socorro_profiles->filter(function($data) use ($currentDate) {
                ...
                <table class="mt-5" id="responsive-table">
                    ...
                    @foreach ($filteredProfiles as $data)
                        ...
                        <tr>
                            ...
                            <td>{{ $data->barangay }}</td>
                            <td>
                                <a href="{{ url('socorro-profile', $data->id) }}" class="btn btn-success">
