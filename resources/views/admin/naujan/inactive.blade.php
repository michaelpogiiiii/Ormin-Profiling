...
<html lang="en" class="light">
    ...
    <body class="py-5 md:py-0 bg-black/[0.15] dark:bg-transparent">
        ...
        @include('admin.naujan.mobile')

<div class="flex mt-[4.7rem] md:mt-0 overflow-hidden">
        @include('admin.naujan.sidebar')
            ...
            <div class="content">
                ...
                <div class="top-bar -mx-4 px-4 md:mx-0 md:px-0">
                    ...
                    <nav aria-label="breadcrumb" class="-intro-x mr-auto hidden sm:flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/home">Naujan Admin</a></li>
                ...
                <form action="{{url('nuajan-inactive')}}" type="GET" >
                ...
                <!-- END: Top Bar -->
                <div class="mt-3">
                  <a href="{{url('naujanprofile')}}" class="btn btn-success">View Active Profiles</a>
                </div>
                @php
                use Carbon\Carbon;
                $currentDate = Carbon::now();
                $filteredProfiles = $naujan_profiles->filter(function($data) use ($currentDate) {
                ...
                <table class="mt-5" id="responsive-table">
                    ...
                    @foreach ($filteredProfiles as $data)
                        ...
                        <tr>
                            ...
                            <td>{{ $data->barangay }}</td>
                            <td>
                                <a href="{{ url('naujan-profile-inactive', $data->id) }}" class="btn btn-success">
